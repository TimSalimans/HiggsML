                     ...
                     const char *fdic_fn) 
{
  ...
  read_feat(feat_fn, fdic_fn, &m_feat, &sp_f_dic); 
  read_target(y_fn, &v_y); 
...
/*------------------------------------------------------------------*/
/* static */
void AzSvDataS::read_target(const char *y_fn, AzDvect *v_y)
{
  AzSmat m_y; 
  readData(y_fn, 1, &m_y); 
...
/*------------------------------------------------------------------*/
void AzSvDataS::parseDataLine(const AzByte *inp, 
                              int inp_len, 
                              int f_num, 
                              const char *data_fn, 
                              int line_no, 
                              ...
                              int col)
{
  const char *eyec = "AzSvDataS::parseDataLine"; 
...
void AzSvDataS::readData_Small(const char *data_fn, 
                         ...
                         AzSmat *m_feat)
{
  const char *eyec = "AzSvDataS::readData"; 
...
/*------------------------------------------------------------------*/
void AzSvDataS::parseDataLine_Sparse(const AzByte *inp, 
                              int inp_len, 
                              int f_num, 
                              const char *data_fn, 
                              int line_no, 
                              ...
                              int col)
{
  const char *eyec = "AzSvDataS::parseDataLine_Sparse"; 

  AzIntArr ia_isUsed; 
  ia_isUsed.reset(m_feat->rowNum(), 0); 
